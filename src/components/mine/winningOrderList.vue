<template>
  <div id="winningOrderList" class="ol-container">
...
methods: {
  getOrderDetail(id){
   ...
   var start = this.winningOrderList.length;
   this.busy = true;
   ...
   $.ajax({
    ...
    success: function(response) {
        that.winningOrderList=dataRecombinant(response.data);
